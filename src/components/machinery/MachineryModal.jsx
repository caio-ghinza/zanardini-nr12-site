...
export default function MachineryModal({ 
  ...
  const handleDeleteClick = () => {
    if (window.confirm(`AVISO CRÍTICO: Deseja realmente excluir o registro da máquina "${machine.name}"? Esta ação removerá permanentemente todos os documentos, imagens e dados de auditoria vinculados.`)) {
